...
if (!class_exists('ScrollMeUpClient')) {
    class ScrollMeUpClient
    {
        ...
        public function __construct()
        {
            ...
            add_action( 'wp_enqueue_scripts', array( $this, 'scrollmeup_client_enqueue' ) );
            add_action( 'wp_footer', array( $this, 'scrollmeup_client_script' ) );
        }
        function scrollmeup_client_enqueue()
        {
            wp_enqueue_style('scrollmeup-client-main', SCROLLMEUP_CSS_DIR.'client_main.css', array(), SCROLLMEUP_VERSION);
            wp_enqueue_script( 'scrollmeup-client-main', SCROLLMEUP_JS_DIR.'client_main.js', array(), SCROLLMEUP_VERSION);
