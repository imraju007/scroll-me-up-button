...
if (!class_exists('ScrollMeUpAdmin')) {
    class ScrollMeUpAdmin
    {
        ...
        public function __construct()
        {
            ...
            add_action("admin_menu", array($this, 'scrollmeup_admin_menu'));
            add_action('admin_enqueue_scripts', array($this, 'scrollmeup_admin_enqueue'));
        ...
        function scrollmeup_admin_menu()
        {
            ...
            add_menu_page("ScrollMeUp", "ScrollMeUp", 'manage_options', "scrollmeup-dashboard", array($this, 'scrollmeup_admin_dashboard'), $icon_url, 6);
            add_submenu_page("scrollmeup-dashboard", "ScrollMeUp", 'Dashboard', "manage_options", 'scrollmeup-dashboard', array($this, 'scrollmeup_admin_dashboard'));
        }
